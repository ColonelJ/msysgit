...
# build directory.
TK_BUILD_LIB_SPEC='-L/src/tcltk/tk8.6.3/win -ltk86'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/src/tcltk/tk8.6.3/win -ltkstub86'
...
TK_BUILD_STUB_LIB_PATH='/src/tcltk/tk8.6.3/win/libtkstub86.a'
