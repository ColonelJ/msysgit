...
# build directory.
TCL_BUILD_LIB_SPEC='-L/src/tcltk/tcl8.6.3/win -ltcl86'
...
# compiled.
TCL_SRC_DIR='/src/tcltk/tcl8.6.3'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/src/tcltk/tcl8.6.3/win -ltclstub86'
...
TCL_BUILD_STUB_LIB_PATH='/src/tcltk/tcl8.6.3/win/libtclstub86.a'
